...
const WelcomePage = () => {
  return (
    ...
    >   
      ...
      <div class="position-absolute p-3 mb-2 bg-black top-10 start-50 translate-middle rounded-circle">        
        <img src={process.env.PUBLIC_URL + logo} alt="GymFlow logo" height="400px" />
      </div>   
      
   
      <Container class="position-absolute top-50 start-50 translate-middle">
        <Row>
          <Col md={12}>
